...
export CLUTTER_DEFAULT_FPS="${CLUTTER_DEFAULT_FPS:-60}"
export MUTTER_DEBUG_FORCE_KMS_MODE="${MUTTER_DEBUG_FORCE_KMS_MODE:-simple}"
export GDK_DISABLE="${GDK_DISABLE:-vulkan}"
