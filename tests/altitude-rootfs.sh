...
[ -x "$TMP/final-root/bin/alt-ide-terminal" ]
[ -x "$TMP/final-root/bin/altitude-ide-ui" ]
[ -x "$TMP/final-root/bin/alt-keyboard-layout" ]
[ -x "$TMP/final-root/bin/alt-vim" ]
...
[ -f "$TMP/final-root/etc/altitude/vim/ide.vim" ]
[ -f "$TMP/final-root/etc/default/keyboard" ]
[ -f "$TMP/final-root/etc/fonts/conf.d/50-altitude-fonts.conf" ]
[ -f "$TMP/final-root/etc/vconsole.conf" ]
[ -f "$TMP/final-root/usr/share/glib-2.0/schemas/90_altitude-fonts.gschema.override" ]
[ -f "$TMP/final-root/usr/share/applications/altitude-dev-console.desktop" ]
[ -f "$TMP/final-root/usr/share/applications/altitude-ide.desktop" ]
